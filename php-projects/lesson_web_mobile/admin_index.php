...
<body>
<?php
	$path_navigationadmin_file = $_SERVER['DOCUMENT_ROOT'] . "/php-project-rizkahadi/lesson_web_mobile/setup/navigationadmin.html";
	include($path_navigationadmin_file);
?>
<div class="banner-bootom-w3-agileits">
	<div class="container">
		<div class="col-md-5 bb-grids bb-left-agileits-w3layouts">
			<a href="../lesson_web_mobile/content/wanita/baju/index.php">
