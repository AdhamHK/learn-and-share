	...
	<div class="container">  
		<div class="single-page">
			<ol class="breadcrumb">
			  ...
			  <li><a href="../../../content/pria/tas/index.php">Tas Pria</a></li>
			...
			<div class="single-page-row" id="detail-21">
				<div class="col-md-6 single-top-left">	
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="../../../static/src/images/tascowok2_1.jpg">
								<div class="thumb-image detail_images"> <img src="../../../static/src/images/tascowok2_1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/tascowok2_2.jpg">
								 <div class="thumb-image"> <img src="../../../static/src/images/tascowok2_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/tascowok2_3.jpg">
							   <div class="thumb-image"> <img src="../../../static/src/images/tascowok2_3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-6 single-top-right">
					<h3 class="item_name">Tas</h3>
			...
			<div class="tab-content">
			  	<div class="tab-pane active" id="1">
          			<div class="row">
          				<div class="col-md-12">
							<p>
								<b>SKU (simple)</b> : FD876778678AA523F1<br/>
								<b>Warna</b> : 	Biru Donker<br/>
								<b>Petunjuk Perawatan</b> : Cuci dengan air dan sabun, Gunakan sikat lembut untu membantu membersihkan bagian dalam, Jemur dibawah terik matahari<br/><br/>
							</p>
						</div>
          			</div>
				</div>
				<div class="tab-pane" id="2">
					<div class="row">
          				<div class="col-md-6">
							<p>
								Terdapat Pocket Laptop <br/>
								Terdapat Tempat Handphone <br/>
								Terdapat Cover Pelindung <br/>
							</p>
						</div>
						<div class="col-md-6">
							<p>
