	...
	<div class="container">  
		<div class="single-page">
			<ol class="breadcrumb">
			  ...
			  <li><a href="../../../content/pria/jam_tangan/index.php">Jam Tangan Pria</a></li>
			  <li class="active">Jam Tangan</li>
			</ol>
			<div class="single-page-row" id="detail-21">
				<div class="col-md-6 single-top-left">	
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="../../../static/src/images/jam2_1.jpg">
								<div class="thumb-image detail_images"> <img src="../../../static/src/images/jam2_1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/jam2_2.jpg">
								 <div class="thumb-image"> <img src="../../../static/src/images/jam2_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/jam2_3.jpg">
							   <div class="thumb-image"> <img src="../../../static/src/images/jam2_3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-6 single-top-right">
					<h3 class="item_name">Jam Tangan</h3>
			...
			<div class="tab-content">
			  	<div class="tab-pane active" id="1">
          			<div class="row">
          				<div class="col-md-12">
							<p>
								<b>SKU (simple)</b> : H8561GDC3AA523F13FG<br/>
								<b>Warna</b> : 	Hitam Gold<br/>
								<b>Petunjuk Perawatan</b> : Hindarkan dengan barang barang seperti medan magnet<br/><br/>
							</p>
						</div>
          			</div>
				</div>
