	...
	<div class="container">  
		<div class="single-page">
			<ol class="breadcrumb">
			  ...
			  <li class="active">Topi Millenium</li>
			</ol>
			<div class="single-page-row" id="detail-21">
				<div class="col-md-6 single-top-left">	
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="../../../static/src/images/aksesoriscowok2_1.jpg">
								<div class="thumb-image detail_images"> <img src="../../../static/src/images/aksesoriscowok2_1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/aksesoriscowok2_2.jpg">
								 <div class="thumb-image"> <img src="../../../static/src/images/aksesoriscowok2_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/aksesoriscowok2_3.jpg">
							   <div class="thumb-image"> <img src="../../../static/src/images/aksesoriscowok2_3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-6 single-top-right">
					<h3 class="item_name">Topi Millenium</h3>
