	...
	<div class="container">  
		<div class="single-page">
			<ol class="breadcrumb">
			  ...
			  <li><a href="../../../content/pria/aksesoris/index.php">Aksesoris Pria</a></li>
			  <li class="active">Sabuk Classic Silver</li>
			</ol>
			<div class="single-page-row" id="detail-21">
				<div class="col-md-6 single-top-left">	
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="../../../static/src/images/aksesoriscowok4_1.jpg">
								<div class="thumb-image detail_images"> <img src="../../../static/src/images/aksesoriscowok4_1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/aksesoriscowok4_2.jpg">
								 <div class="thumb-image"> <img src="../../../static/src/images/aksesoriscowok4_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/aksesoriscowok4_3.jpg">
							   <div class="thumb-image"> <img src="../../../static/src/images/aksesoriscowok4_3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-6 single-top-right">
					<h3 class="item_name">Sabuk Classic Silver</h3>
			...
			<div class="tab-content">
			  	<div class="tab-pane active" id="1">
          			<div class="row">
          				<div class="col-md-12">
							<p>
								<b>SKU (simple)</b> : C71C3AA5863F13FGS<br/>
								<b>Warna</b> : 	Hitam Silver<br/>
								<b>Petunjuk Perawatan</b> : Sabuk berbahan kulit ini jangan terlalu lama didiamkan didalam almari yang memiliki kelembaban rendah<br/><br/>
							</p>
						</div>
          			</div>
				</div>
