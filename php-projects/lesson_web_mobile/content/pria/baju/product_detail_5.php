	...
	<div class="container">  
		<div class="single-page">
			<ol class="breadcrumb">
			  ...
			  <li><a href="../../../content/pria/baju/index.php">Pakaian Pria</a></li>
			  <li class="active">Kemeja</li>
			</ol>
			<div class="single-page-row" id="detail-21">
				<div class="col-md-6 single-top-left">	
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="../../../static/src/images/pria5_1.jpg">
								<div class="thumb-image detail_images"> <img src="../../../static/src/images/pria5_1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/pria5_2.jpg">
								 <div class="thumb-image"> <img src="../../../static/src/images/pria5_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/pria5_3.jpg">
							   <div class="thumb-image"> <img src="../../../static/src/images/pria5_3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-6 single-top-right">
					<h3 class="item_name">Kemeja</h3>
			...
			<div class="tab-content">
			  	<div class="tab-pane active" id="1">
          			<div class="row">
          				<div class="col-md-12">
							<p>
								<b>SKU (simple)</b> : G96732GD3AA523F13FGS<br/>
								<b>Warna</b> : 	Putih Hitam<br/>
