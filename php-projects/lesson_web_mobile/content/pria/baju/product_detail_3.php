			...
			<div class="single-page-row" id="detail-21">
				<div class="col-md-6 single-top-left">	
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="../../../static/src/images/pria3_1.jpg">
								<div class="thumb-image detail_images"> <img src="../../../static/src/images/pria3_1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/pria3_2.jpg">
								 <div class="thumb-image"> <img src="../../../static/src/images/pria3_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/pria3_3.jpg">
							   <div class="thumb-image"> <img src="../../../static/src/images/pria3_3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-6 single-top-right">
					<h3 class="item_name">Zalia - Ombre Flare Sleeve Dress</h3>
