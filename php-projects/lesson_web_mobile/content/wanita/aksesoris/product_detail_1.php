			...
			<div class="single-page-row" id="detail-21">
				<div class="col-md-6 single-top-left">	
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="../../../static/src/images/aksesoriscewek1_1.jpg">
								<div class="thumb-image detail_images"> <img src="../../../static/src/images/aksesoriscewek1_1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/aksesoriscewek1_2.jpg">
								 <div class="thumb-image"> <img src="../../../static/src/images/aksesoriscewek1_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/aksesoriscewek1_3.jpg">
							   <div class="thumb-image"> <img src="../../../static/src/images/aksesoriscewek1_3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li> 
						</ul>
					</div>
				</div>
			...
			<div class="tab-content">
			  	<div class="tab-pane active" id="1">
          			<div class="row">
          				<div class="col-md-12">
							<p>
								<b>SKU (simple)</b> : RTE1C3AA523F13FGS<br/>
								<b>Warna</b> : 	Gold<br/>
