	...
	<div class="container">  
		<div class="single-page">
			<ol class="breadcrumb">
			  ...
			  <li><a href="../../../content/wanita/aksesoris/index.php">Aksesoris Wanita</a></li>
			  <li class="active">Kalung</li>
			</ol>
			<div class="single-page-row" id="detail-21">
				<div class="col-md-6 single-top-left">	
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="../../../static/src/images/aksesoriscewek4_1.jpg">
								<div class="thumb-image detail_images"> <img src="../../../static/src/images/aksesoriscewek4_1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/aksesoriscewek4_2.jpg">
								 <div class="thumb-image"> <img src="../../../static/src/images/aksesoriscewek4_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/aksesoriscewek4_3.jpg">
							   <div class="thumb-image"> <img src="../../../static/src/images/aksesoriscewek4_3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li> 
						</ul>
					</div>
				</div>
				<div class="col-md-6 single-top-right">
					<h3 class="item_name">Kalung</h3>
			...
			<div class="tab-content">
			  	<div class="tab-pane active" id="1">
          			<div class="row">
          				<div class="col-md-12">
							<p>
								<b>SKU (simple)</b> : YE667C3AA523F13UIYS<br/>
								<b>Warna</b> :  Hijau Gold<br/>
								<b>Petunjuk Perawatan</b> : Jika terdapat noda pada aksesoris kalung tersebut maka gunakan kapas dengan aseton untuk membersihkan<br/><br/>
							</p>
						</div>
          			</div>
				</div>
