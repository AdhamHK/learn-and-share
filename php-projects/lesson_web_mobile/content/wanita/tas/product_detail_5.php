	...
	<div class="container">  
		<div class="single-page">
			<ol class="breadcrumb">
			  ...
			  <li><a href="../../../content/wanita/tas/index.php">Tas Wanita</a></li>
			...
			<div class="single-page-row" id="detail-21">
				<div class="col-md-6 single-top-left">	
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="../../../static/src/images/tascewek5.jpg">
								<div class="thumb-image detail_images"> <img src="../../../static/src/images/tascewek5.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/tascewek5_2.jpg">
								 <div class="thumb-image"> <img src="../../../static/src/images/tascewek5_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/tascewek5_3.jpg">
							   <div class="thumb-image"> <img src="../../../static/src/images/tascewek5_3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li> 
						</ul>
					</div>
				</div>
