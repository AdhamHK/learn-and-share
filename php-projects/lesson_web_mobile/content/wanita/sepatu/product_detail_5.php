	...
	<div class="container">  
		<div class="single-page">
			<ol class="breadcrumb">
			  ...
			  <li><a href="../../../content/wanita/sepatu/index.php">Sepatu Wanita</a></li>
			...
			<div class="single-page-row" id="detail-21">
				<div class="col-md-6 single-top-left">	
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="../../../static/src/images/sepatucewek5_1.jpg">
								<div class="thumb-image detail_images"> <img src="../../../static/src/images/sepatucewek5_1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/sepatucewek5_2.jpg">
								 <div class="thumb-image"> <img src="../../../static/src/images/sepatucewek5_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/sepatucewek5_2.jpg">
							   <div class="thumb-image"> <img src="../../../static/src/images/sepatucewek5_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li> 
			...
			<div class="tab-content">
			  	<div class="tab-pane active" id="1">
          			<div class="row">
          				<div class="col-md-12">
							<p>
								<b>SKU (simple)</b> : HDAHJGDA78878HJG3FGS<br/>
								<b>Warna</b> : 	Coklat Pastel<br/>
								<b>Petunjuk Perawatan</b> : Sikat menggunakan sikat lembut dan sabun, jangan dijemur dibawah terik matahari secara langsung<br/><br/>
							</p>
						</div>
          			</div>
				</div>
