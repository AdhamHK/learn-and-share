		...
		<div class="col-md-8 col-sm-8 women-dresses">
			<div class="women-set1">
				...
				<div class="col-md-4 women-grids wp2 animated wow slideInUp" data-wow-delay=".5s">
					<a href="../../../content/wanita/baju/product_detail_2.php"><div class="product-img">
						<img src="../../../static/src/images/wanita2.jpg" alt="" />
						<div class="p-mask">
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart" />
								<input type="hidden" name="add" value="1" /> 
				...
				<div class="col-md-4 women-grids wp3 animated wow slideInUp" data-wow-delay=".5s">
					<a href="../../../content/wanita/baju/product_detail_3.php"><div class="product-img">
						<img src="../../../static/src/images/wanita3.jpg" alt="" />
						<div class="p-mask">
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart" />
								<input type="hidden" name="add" value="1" /> 
			...
			<div class="women-set2">
				<div class="col-md-4 women-grids wp4 animated wow slideInUp" data-wow-delay=".5s">
					<a href="../../../content/wanita/baju/product_detail_4.php"><div class="product-img">
						<img src="../../../static/src/images/wanita4.jpg" alt="" />
						<div class="p-mask">
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart" />
								<input type="hidden" name="add" value="1" /> 
				...
				<div class="col-md-4 women-grids wp5 animated wow slideInUp" data-wow-delay=".5s">
					<a href="../../../content/wanita/baju/product_detail_5.php"><div class="product-img">
						<img src="../../../static/src/images/wanita5.jpg" alt="" />
						<div class="p-mask">
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart" />
								<input type="hidden" name="add" value="1" /> 
				...
				<div class="col-md-4 women-grids wp6 animated wow slideInUp" data-wow-delay=".5s">
					<a href="../../../content/wanita/baju/product_detail_6.php"><div class="product-img">
						<img src="../../../static/src/images/wanita6.jpg" alt="" />
						<div class="p-mask">
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart" />
								<input type="hidden" name="add" value="1" /> 
