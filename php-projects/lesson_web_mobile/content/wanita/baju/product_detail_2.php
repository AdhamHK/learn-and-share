			...
			<div class="single-page-row" id="detail-21">
				<div class="col-md-6 single-top-left">	
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="../../../static/src/images/wanita2_1.jpg">
								<div class="thumb-image detail_images"> <img src="../../../static/src/images/wanita2_1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/wanita2_2.jpg">
								 <div class="thumb-image"> <img src="../../../static/src/images/wanita2_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/wanita2_2.jpg">
							   <div class="thumb-image"> <img src="../../../static/src/images/wanita2_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li> 
			...
			<div class="tab-content">
			  	<div class="tab-pane active" id="1">
          			<div class="row">
          				<div class="col-md-12">
							<p>
								<b>SKU (simple)</b> : TYRY777A523F13FGS<br/>
								<b>Warna</b> : 	Pink Pastel <br/>
					...
					<div class="row">
          				<div class="col-md-6">
							<p>
								...
								- S (37.5cm x 74cm x 77cm x 106cm x 137cm) <br/>
								- M (49cm x 100cm x 81cm x 132cm x 148.5cm) <br/>
							</p>
						</div>
						<div class="col-md-6">
							<p>
