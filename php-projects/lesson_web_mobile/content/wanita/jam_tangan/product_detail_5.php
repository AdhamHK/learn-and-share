			...
			<div class="single-page-row" id="detail-21">
				<div class="col-md-6 single-top-left">	
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="../../../static/src/images/jamcewek5_1.jpg">
								<div class="thumb-image detail_images"> <img src="../../../static/src/images/jamcewek5_1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/jamcewek5_2.jpg">
								 <div class="thumb-image"> <img src="../../../static/src/images/jamcewek5_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="../../../static/src/images/jamcewek5_2.jpg">
							   <div class="thumb-image"> <img src="../../../static/src/images/jamcewek5_2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li> 
			...
			<div class="tab-content">
			  	<div class="tab-pane active" id="1">
          			<div class="row">
          				<div class="col-md-12">
							<p>
								<b>SKU (simple)</b> : GAGF890C3AA523F13F<br/>
								<b>Warna</b> : 	Putih<br/>
								<b>Petunjuk Perawatan</b> : Jangan didekatkan dengan barang barang yang memiliki medan magnet<br/><br/>
							</p>
						</div>
          			</div>
				</div>
