...
<section id="home-section">
   <div class="home-inner row">
      <div class="col-md-6">
         <h1 id="plugin-name" class="font-title">Rizka Hadi</h1>
...
<section id="section1" class="section-white">
   <div class="container">
      <div class="row">
      	 <div class="col-md-4">
      	 	<?php
      	 		$url = "/php-project-rizkahadi/index.html";
         ...
         <center><h2>Result Algoritma Stemming Porter Bahasa Indonesia : </h2></center><hr/>
		  <table class="table table-hover">
		    ...
		    <tbody>
				<?php
					$awal = microtime(true);
					$path_lib_stemming = $_SERVER['DOCUMENT_ROOT'] . "/php-project-rizkahadi/models/stemming.php";
					$path_lib_nazief = $_SERVER['DOCUMENT_ROOT'] . "/php-project-rizkahadi/models/AJAX_SERVER_stemming.php";
